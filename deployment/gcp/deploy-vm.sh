...
if [[ -z "$PROJECT_ID" ]]; then
  ...
  echo "  PROJECT_ID=my-project NAMESPACE=staging VM_NAME=my-proxy ZONE=us-west1-a $0"
  echo "  PROJECT_ID=my-project NAMESPACE=production NETWORK=staging-network SUBNET=subnet-southeast $0"
  exit 1
fi
